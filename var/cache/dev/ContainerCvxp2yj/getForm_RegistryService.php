...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\CourseInstanceType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\CourseInstanceType']) ? $this->services['AppBundle\Form\CourseInstanceType'] : $this->services['AppBundle\Form\CourseInstanceType'] = new \AppBundle\Form\CourseInstanceType()) && false ?: '_'};
}, 'AppBundle\\Form\\CourseSoftPrerequisiteType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\CourseSoftPrerequisiteType']) ? $this->services['AppBundle\Form\CourseSoftPrerequisiteType'] : $this->services['AppBundle\Form\CourseSoftPrerequisiteType'] = new \AppBundle\Form\CourseSoftPrerequisiteType()) && false ?: '_'};
}, 'AppBundle\\Form\\CourseTypeType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\CourseTypeType']) ? $this->services['AppBundle\Form\CourseTypeType'] : $this->services['AppBundle\Form\CourseTypeType'] = new \AppBundle\Form\CourseTypeType()) && false ?: '_'};
}, 'AppBundle\\Form\\EmailType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\EmailType']) ? $this->services['AppBundle\Form\EmailType'] : $this->services['AppBundle\Form\EmailType'] = new \AppBundle\Form\EmailType()) && false ?: '_'};
}, 'AppBundle\\Form\\EnrolledType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\EnrolledType']) ? $this->services['AppBundle\Form\EnrolledType'] : $this->services['AppBundle\Form\EnrolledType'] = new \AppBundle\Form\EnrolledType()) && false ?: '_'};
}, 'AppBundle\\Form\\PlaceType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\PlaceType']) ? $this->services['AppBundle\Form\PlaceType'] : $this->services['AppBundle\Form\PlaceType'] = new \AppBundle\Form\PlaceType()) && false ?: '_'};
...
}, 'AppBundle\\Form\\WorkplaceType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\WorkplaceType']) ? $this->services['AppBundle\Form\WorkplaceType'] : $this->services['AppBundle\Form\WorkplaceType'] = new \AppBundle\Form\WorkplaceType()) && false ?: '_'};
